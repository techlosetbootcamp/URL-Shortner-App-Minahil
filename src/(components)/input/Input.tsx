...
function InputField({type="text",placeholder, value, label, onChange, disabled}:inputType){
    return(
        <input value={value} onChange={onChange} disabled={disabled} style={{
          ...
          }} className="shadow-custom border-4 text-text_secondary font-light text-[14px] bg-input_bg_clr border-input_border_clr rounded-[48px] py-[15px] md:py-[21px] pr-[25.19px] pl-[25px]" type={type} placeholder={placeholder} />
    );
