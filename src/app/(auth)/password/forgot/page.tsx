...
function ForgotPassword()
{
    return(
        ...
        <div className="flex flex-col items-center justify-center mb-[262px] mt-[216px]">
            ...
            <p className="font-extrabold text-[60px] leading-[80.01px] animate-text bg-gradient-to-r from-[#144EE3] via-[#EB568E] to-[#A353AA] bg-clip-text text-transparent">Forgot Password</p>
